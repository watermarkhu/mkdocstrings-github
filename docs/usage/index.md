...
This package is extension package to [*mkdocstrings*](https://mkdocstrings.github.io/), a framework for auto-documentation within [Material for MkDocs](https://squidfunk.github.io/mkdocs-material/) or [Zensical](https://zensical.org/about/). Language support is inserted into the framework by providing *handlers*. The *mkdocstrings-github* package provides a GitHub handler.
